...
class SettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'battery_very_good' => ['required', 'numeric', 'min:-50', 'max:50'],
            'battery_good' => ['required', 'numeric', 'min:-50', 'max:50'],
            'battery_fair' => ['required', 'numeric', 'min:-50', 'max:50'],
            'battery_regular' => ['required', 'numeric', 'min:-50', 'max:50'],
            'battery_weak' => ['required', 'numeric', 'min:-50', 'max:50'],
        ...
        CompanySetting::updateOrCreate(
            ...
            [
                ...
                'battery_rules' => [
                    ['min' => 95, 'max' => 100, 'modifier' => (float) $data['battery_excellent']],
                    ['min' => 90, 'max' => 94,  'modifier' => (float) $data['battery_very_good']],
                    ['min' => 85, 'max' => 89,  'modifier' => (float) $data['battery_good']],
                    ['min' => 80, 'max' => 84,  'modifier' => (float) $data['battery_fair']],
                    ['min' => 75, 'max' => 79,  'modifier' => (float) $data['battery_regular']],
                    ['min' => 70, 'max' => 74,  'modifier' => (float) $data['battery_weak']],
